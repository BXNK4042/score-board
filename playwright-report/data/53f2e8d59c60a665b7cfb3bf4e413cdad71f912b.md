...
- Name: tier2.spec.ts >> Tier 2 - Boundary & Corner Cases >> 29. In-Game - Bulk selection count matches selected players
- Location: tests/tier2.spec.ts:357:7
...
- text: PLAYER 2
- checkbox "Select Bob for bulk action"
- text: B Bob
- button "Decrease score for Bob": −
- text: "0"
- button "Increase score for Bob": +
