...
- Name: tier2.spec.ts >> Tier 2 - Boundary & Corner Cases >> 19. In-Game - Decimals are not allowed (only integer score shifts)
- Location: tests/tier2.spec.ts:215:7
...
Expected: visible
Error: strict mode violation: locator('text=1') resolved to 2 elements:
    ...
    2) <div aria-live="polite" class="text-5xl font-black min-w-[60px] text-center" data-testid="player-score-af0b228b-ffa8-4b5b-9573-50dc723121bc">1</div> aka getByTestId('player-score-af0b228b-ffa8-4b5b-9573-50dc723121bc')
...
- generic [ref=e1]:
  ...
  - alert [ref=e11]
  - generic [ref=e13]:
    - heading "In-Game Screen" [level=1] [ref=e14]
    - generic [ref=e15]:
      - generic [ref=e16]:
        - generic [ref=e17]:
          - img [ref=e18]
          - button "Edit game title" [ref=e20]: My Game
        - generic [ref=e21]:
          - button "Add player mid-game" [ref=e22]:
            - img
          - button "End Game" [ref=e23]:
            - img
      - generic [ref=e24]:
        - generic [ref=e27]: LIVE SESSION
        - generic [ref=e28]:
          - generic [ref=e29]: 00:00:01
          - button "Pause stopwatch" [ref=e30]:
            - img
      - generic [ref=e35] [cursor=pointer]:
        - generic [ref=e36]:
          - generic [ref=e37]: LEADER
          - checkbox "Select Alice for bulk action" [ref=e39]
        - generic [ref=e40]:
          - generic [ref=e41]:
            - generic [ref=e43]: A
            - generic [ref=e44]: Alice
          - generic [ref=e45]:
            - button "Decrease score for Alice" [ref=e46]: −
            - generic [ref=e47]: "1"
            - button "Increase score for Alice" [active] [ref=e48]: +
```
