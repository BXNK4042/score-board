...
test.describe('Tier 4 - Real-World Application Scenarios', () => {
  ...
  test('1. Scenario 1 - 2-Player Card Game (Happy Path)', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid^="player-card-"]').filter({ hasText: 'Alice' }).locator('[data-testid^="player-score-"]')).toHaveText('2');
  ...
  test('3. Scenario 3 - Bulk Scoring & Deselection', async ({ page }) => {
    ...
    // Verify scores
    await expect(page.locator('[data-testid^="player-card-"]').filter({ hasText: 'Player 1' }).locator('[data-testid^="player-score-"]')).toHaveText('2');
    await expect(page.locator('[data-testid^="player-card-"]').filter({ hasText: 'Player 2' }).locator('[data-testid^="player-score-"]')).toHaveText('2');
    await expect(page.locator('[data-testid^="player-card-"]').filter({ hasText: 'Player 3' }).locator('[data-testid^="player-score-"]')).toHaveText('0');
  ...
  test('4. Scenario 4 - Mid-Game Player Addition & Persistence', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid^="player-card-"]').filter({ hasText: 'Charlie' }).locator('[data-testid^="player-score-"]')).toHaveText('0');
